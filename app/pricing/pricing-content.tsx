  ...
  return (
    <div className={styles.shell}>
      <header className={styles.hero}>
        ...
        <nav className={styles.sectionLinks} aria-label="Pricing sections">
          <a href="#owners">Owners</a><a href="#partners">Dealers &amp; Middlemen</a><a href="#assistance">Capture &amp; assistance</a>
        </nav>
      </header>

      <section id="owners" className={styles.section} aria-labelledby="owner-title">
      ...
      <section id="partners" className={styles.section} aria-labelledby="partner-title">
        <div className={styles.sectionHeading}><div><p className={styles.eyebrow}>For partners</p><h2 id="partner-title">Work with assets. Build your business.</h2><p>Choose the access that matches the work you do.</p></div></div>
      ...
      <section id="assistance" className={styles.section} aria-labelledby="capture-title">
      ...
      <section className={styles.section} aria-labelledby="details-title">
        <div className={styles.sectionHeading}><div><p className={styles.eyebrow}>The details</p><h2 id="details-title">Setup, support and partnership.</h2></div></div>
        <div className={styles.detailsList}>
          <details><summary>Dealer-Managed Owner accounts</summary><div className={styles.detailBody}><p>A Dealer can fund an Owner subscription and manage the account with the Owner’s permission. The Owner keeps their own login, owns their information and can revoke Dealer access.</p>
          ...
          <details><summary>What counts towards my Owner plan?</summary><div className={styles.detailBody}><p>Only active assets count towards the 25, 100 or 300 asset limit. Sold and archived assets do not count. All Owner plans include the same core features, with pricing based on asset quantity rather than storage. Owner accounts require a paid subscription.</p></div></details>
        </div>
      </section>
