...
export default async function OwnerAppValuationPage({
  ...
  searchParams?: { from?: string | string[]; mode?: string | string[] };
}) {
  ...
  const useMatureFlow = mode === 'detailed';
  ...
  return (
    <div className={styles.module}>
      ...
      />
      {useMatureFlow ? <ValuationClient ownerAppMode /> : <QuickValuationClient ownerAppMode />}
    </div>
  );
}
