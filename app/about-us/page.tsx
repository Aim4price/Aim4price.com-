          ...
          <div className={styles.heroPanel}>
            <div className={styles.heroCopy}>
              ...
              <p className={styles.heroText}>
                ...
                insurers, financiers and accountants together around one trusted
                asset record.
              </p>
      ...
      <section className={styles.valueSection}>
        <div className={styles.shell}>
          <div className={styles.valueHeading}>
            ...
            <p>
              Aim4price turns scattered information into a practical record that
              stays useful throughout ownership.
            </p>
          </div>
          ...
          <div className={styles.contactPanel}>
            <div className={styles.contactCopy}>
              ...
              <p>
                ...
                building a clearer way to work together.
              </p>
            </div>
