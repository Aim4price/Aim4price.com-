...
const ROUTE_LABELS: Array<{
  ...
  { prefix: "/admin/asset-map", key: "admin-asset-map", label: "Admin - Global Asset Map", isAdminArea: true },
  { prefix: "/admin/discovery", key: "admin-discovery", label: "Admin - Discovery", isAdminArea: true },
