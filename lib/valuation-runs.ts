...
function buildValuationPayload(input: SaveValuationRunInput, result: Result, selectedValueExVat: number) {
  return {
    input: {
      ...
      usageMode: input.usageMode ?? (input.lifeWorkedPercent !== null && typeof input.lifeWorkedPercent !== 'undefined' ? 'percent' : 'hours'),
      usage_mode: input.usageMode ?? (input.lifeWorkedPercent !== null && typeof input.lifeWorkedPercent !== 'undefined' ? 'percent' : 'hours'),
      hours: Math.max(0, Number(input.hours) || 0),
      lifeWorkedPercent: input.lifeWorkedPercent ?? null,
      life_worked_percent: input.lifeWorkedPercent ?? null,
      ...
      otherExtraName: input.otherExtraName ?? null,
      otherExtraReplacementPriceExVat: input.otherExtraReplacementPriceExVat ?? input.otherExtraValueExVat ?? null,
    ...
    output: {
      ...
      frontPtoReplacementPriceExVat: result.frontPtoReplacementPriceExVat,
      frontLoaderReplacementPriceExVat: result.frontLoaderReplacementPriceExVat,
      gpsReplacementPriceExVat: result.gpsReplacementPriceExVat,
      otherExtraName: result.otherExtraName,
      otherExtraReplacementPriceExVat: result.otherExtraReplacementPriceExVat,
