...
test('the Admin Marketplace page is admin-only and exposes the complete filterable history', () => {
  ...
  assert.match(adminMarketplaceClient, /Advertised value/);
  assert.match(adminMarketplaceClient, /aria-label="Marketplace listings"/);
  assert.match(adminMarketplaceClient, /Asset or seller/);
  ...
  assert.match(adminMarketplaceClient, /Marketplace popularity filter/);
