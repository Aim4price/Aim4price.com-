...
- New families use the explicit Basic usage profiles: hours, kilometres or
  percentage worked, with a rounded useful-life guide. Percentage remains an
  option when a meter reading is unknown. See [BASIC-USAGE-PROFILES.md](BASIC-USAGE-PROFILES.md).
...
## Usage and lifetime follow-up

See [BASIC-USAGE-PROFILES.md](BASIC-USAGE-PROFILES.md) for the Basic-only usage profiles covering all 713 families. The profile change needs an application deployment, with no database import or new environment variable.
