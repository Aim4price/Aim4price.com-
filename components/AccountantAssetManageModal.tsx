            ...
            <form className={`${styles.accountantManageForm} ${styles.accountantFinanceForm}`} onSubmit={saveFinance}>
              ...
              <section className={styles.accountantFinanceSection}>
                ...
                <div className={styles.accountantManageGrid}>
                  ...
                  <label className={styles.assetSettingsField}><span>Acquisition date <small>(optional)</small></span><DateInput value={finance.financeBoughtWhen} onValueChange={(value) => setFinance((current) => ({ ...current, financeBoughtWhen: value }))} disabled={!allowDirectUpdates}/></label>
              ...
              {financeHasAgreement && showFinanceAdvanced ? <>
                <section className={styles.accountantFinanceSection}>
                  ...
                  <div className={styles.accountantManageGrid}>
                    ...
                    <label className={styles.assetSettingsField}><span>Balloon date</span><DateInput value={finance.balloonDate} onValueChange={(value) => setFinance((current) => ({ ...current, balloonDate: value }))} disabled={!allowDirectUpdates}/></label>
                    {financeDateFields.map(([key, label]) => <label className={styles.assetSettingsField} key={key}><span>{label}</span><DateInput value={finance[key]} onValueChange={(value) => setFinance((current) => ({ ...current, [key]: value }))} disabled={!allowDirectUpdates}/></label>)}
                ...
                <section className={styles.accountantFinanceSection}>
                  ...
                  <div className={styles.accountantManageGrid}>
                    ...
                    <label className={styles.assetSettingsField}><span>Allocation date</span><DateInput value={finance.allocationDate} onValueChange={(value) => setFinance((current) => ({ ...current, allocationDate: value }))} disabled={!allowDirectUpdates}/></label>
          ...
          {view === 'accounting' ? (
            <form className={styles.accountantManageForm} onSubmit={saveAccounting}>
              ...
              <div className={styles.accountantManageGrid}>
                ...
                <label className={styles.assetSettingsField}><span>Book-value date</span><DateInput value={asAtDate} onValueChange={(value) => setAsAtDate(value)} disabled={!allowDirectUpdates} required/></label>
          ...
          {view === 'dispose' ? (
            <form className={styles.accountantManageForm} onSubmit={saveLifecycle}>
              ...
              <div className={styles.accountantManageGrid}>
                ...
                <label className={styles.assetSettingsField}><span>Effective date</span><DateInput value={lifecycleDate} onValueChange={(value) => setLifecycleDate(value)} disabled={!allowDirectUpdates} required/></label>
