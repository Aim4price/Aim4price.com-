...
The first report PR (#861) was merged. This follow-up remains for review. Live verification reached the Aim4price sign-in screen; authenticated owner/dealer/accountant downloads and external map/image availability still need an authenticated session. No schema migration is required.
